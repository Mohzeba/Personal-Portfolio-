...
const About = () => {
  ...
  return (
    <section className="c-space section-spacing">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] ms-12">
        {/* Grid 1 */}
        <div className= " flex items-end grid-default-color grid-1">
          ...
          <div className="z-10">
            <p className="headtext">Hey, I'm Baig Mohzeba</p>
            <p className="subtext">Over the last few years, I developed a passion for creating digital experiences that are both functional and visually appealing.</p>
          </div>
        ...
        <div className="grid-default-color grid-2">
          <div ref={grid2container} className="flex items-center justify-center w-full h-full">
            ...
            <Card style={{rotate:"70deg", top:"30%", left:"20%"}}text="GRASP"
        ...
        <div className="grid-default-color grid-5">
          <div className= "absolute inset-y-0 md:inset-y-9 w-full start-[50%] md:scale-125"></div>
            <Frameworks />
        </div>
      </div>
    </section>
